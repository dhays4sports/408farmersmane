export const SMS_PVX_MAPPING_BUILD = 'CF-PVX-SMS-1.1';
...
export const SMS_PVX_PRODUCER_SAFE_INTENTS = Object.freeze(['auto', 'life', 'business', 'other', '']);
...
export function mapSmsToPvx(source = {}, options = {}) {
  ...
  return {
    ...
    fallbackReason: canEnterPvx ? '' : SMS_PVX_PRODUCER_SAFE_INTENTS.includes(intent) && intent ? 'producer_owned_line_intake' : 'ambiguous_or_missing_intent',
