...
export const SMS_ORCHESTRATOR_BUILD = 'RC-SMS-1.9.7';
...
export const SMS_PRODUCER_START_WORKFLOWS = Object.freeze([
  ...
  'coveragefit_bundle',
  'coveragefit_other',
  'coveragefit_auto_intake',
  'coveragefit_life_intake',
  'coveragefit_business_intake',
  'quote_followup',
  'service',
  'appointment',
  'life',
...
function workflowTypeFromConversation(conversation = {}) {
  ...
  if (intent === 'auto') return 'coveragefit_auto_intake';
  if (intent === 'life') return 'coveragefit_life_intake';
  if (intent === 'business') return 'coveragefit_business_intake';
...
export function startSmsWorkflowEpisode(conversation = {}, workflowType, options = {}) {
  ...
  const mapping = {
    ...
    coveragefit_auto_intake: { owner: 'coveragefit', state: 'auto_vehicle_count_requested', intent: 'auto', mode: 'automated' },
    coveragefit_life_intake: { owner: 'coveragefit', state: 'life_protection_goal_requested', intent: 'life', mode: 'automated' },
    coveragefit_business_intake: { owner: 'coveragefit', state: 'business_industry_requested', intent: 'business', mode: 'automated' },
