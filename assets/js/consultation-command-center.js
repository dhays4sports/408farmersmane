(function (root) {
  ...
  function entryLabel(context) {
    ...
    if (/408 farmers|408farmers/.test(source)) return '408farmers.com agency website';
  ...
  function prospectStory(snapshot) {
    ...
    else if (/408 farmers|408farmers/.test(normalized(context?.source))) sentences.push('The journey began on the agency website at 408farmers.com and continued into CoverageFit.');
