(function () {
  ...
  function humanizeSource(integration) {
    ...
    if (source.includes('408')) return campaign ? `408farmers.com · ${campaign}` : '408farmers.com';
  ...
  function renderClientIntake(snapshot) {
    ...
    updateText(byId('clientIntakeStatus'), integration.prefilled ? 'Agency website handoff' : 'Assessment provided');
    ...
    updateText(byId('clientIntakeNote'), displacement
      ...
      : integration.prefilled
        ? 'Information was carried into CoverageFit from the agency website and remains customer-editable. Confirm contact details and the reason for review before quoting.'
