(function (root, factory) {
  ...
  function install() {
    ...
    if (header && !header.querySelector('.pvx-host-trust')) {
      ...
      trust.textContent = 'Personally reviewed by Dylan Haysbert at Virginia Tam Insurance Agency, Inc. · CA License #4528400';
    ...
    if (title && !doc.getElementById('pvxHostSnapshotLine')) {
      ...
      line.textContent = 'Your CoverageFit Snapshot — personally reviewed by Dylan Haysbert, Insurance Producer, at Virginia Tam Insurance Agency, Inc. · CA License #4528400.';
